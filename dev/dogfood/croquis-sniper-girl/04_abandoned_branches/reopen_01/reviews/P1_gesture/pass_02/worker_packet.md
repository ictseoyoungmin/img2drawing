...
- parent review digest: `6f26015c86b19d34bd04ae5a76b07a9cb2c6c4c84679a8bd716748c3441fcad7`
...
- `P1-R1` replace_stroke / crown_face_spine_support — Pass-1 concerns: no dominant hierarchy, straight facial centre, and an angular pelvis kink. Re-authored as one heavier stroke with a real image-right facial bow and a curved rather than cornered hip handoff.
- `P1-R2` replace_stroke / cranial_crown_arc — Crown arc closed into the side arcs; shortened and pulled clear so a visible gap remains.
- `P1-R3` replace_stroke / cranial_left_temporal_jaw — Left arc met the crown arc and welded into a badge; started lower with a visible gap and stopped before the chin.
- `P1-R4` replace_stroke / cranial_right_temporal_jaw — Right arc closed the egg; started below the crown arc and terminated above the jaw exit.
- `P1-R5` replace_stroke / counterbalance_leg — Counterbalance leg was too faint to read as a distinct role and too straight; strengthened and given the outward brace curve seen in the subject.
- `P1-R6` replace_stroke / shoulder_rhythm — Shoulder rhythm was invisible against the new gesture weight; raised to a readable subordinate level.
- `P1-R7` replace_stroke / pelvis_rhythm — Pelvis rhythm was invisible; raised to a readable subordinate level so the tilt supports the transfer.
- `P1-R8` replace_stroke / rifle_major_axis — Prop axis was invisible although it defines the global envelope; raised but kept below the body gesture.
- `P1-R9` replace_stroke / ground_weight_cue — Ground cue was invisible; raised just enough to state the two landing heights.
...
- subject_vs_drawing: `/home/claude/work/croquis/out/reviews/P1_gesture/pass_02/subject_vs_drawing.png`
- subject_split: `/home/claude/work/croquis/out/reviews/P1_gesture/pass_02/subject_split.png`
- subject_drawing_overlay: `/home/claude/work/croquis/out/reviews/P1_gesture/pass_02/subject_drawing_overlay.png`
- subject_drawing_absdiff: `/home/claude/work/croquis/out/reviews/P1_gesture/pass_02/subject_drawing_absdiff.png`
- grammar_vs_drawing: `/home/claude/work/croquis/out/reviews/P1_gesture/pass_02/grammar_vs_drawing.png`
- exemplar_vs_drawing: `/home/claude/work/croquis/out/reviews/P1_gesture/pass_02/grammar_vs_drawing.png`
- overview: `/home/claude/work/croquis/out/reviews/P1_gesture/pass_02/reference_authority_overview.png`
- three_way: `/home/claude/work/croquis/out/reviews/P1_gesture/pass_02/reference_authority_overview.png`
