# Autonomous worker packet — P1_gesture / pass 3

## Stage pass memory
- state: **revision_continuation**
- prior review count: 2
- parent review digest: `2b4c95a8e7a48ce5587f7d0127e2f2337ef03be4b6cf7affa28593473aa8d90b`
- previous decision: **revise**

### Previous remaining concerns
- counterbalance leg still reads as a ghost line rather than a distinct structural role
- crown arc, shoulder rhythm and pelvis rhythm sit below a readable subordinate weight

### Previous reported corrections
- P1-R1 re-authored the dominant gesture with a real image-right facial bow and a curved hip handoff.
- P1-R2/R3/R4 re-cut the cranial arcs so crown and temporal arcs no longer weld into a badge.
- P1-R5..R9 raised subordinate strokes, but not enough.

### Inter-pass actions since the previous review
- `P1-R10` replace_stroke / counterbalance_leg — Carried concern: the braced leg still read as a ghost line. Raised to major-stroke calibration (~0.90 of the reference gesture) so support and counterbalance are two visibly distinct roles.
- `P1-R11` replace_stroke / cranial_crown_arc — Carried concern: the crown arc had almost no presence, so the crown origin of the gesture was not supported.
- `P1-R12` replace_stroke / cranial_left_temporal_jaw — Raised with the crown arc so the open head envelope stays legible against the darker gesture.
- `P1-R13` replace_stroke / cranial_right_temporal_jaw — Raised with the crown arc; the near-side arc stays slightly heavier than the far side to keep the masses unequal.
- `P1-R14` replace_stroke / shoulder_rhythm — Carried concern: shoulder rhythm sat below readable subordinate weight.
- `P1-R15` replace_stroke / pelvis_rhythm — Carried concern: pelvis rhythm sat below readable subordinate weight and could not support the transfer.
- `P1-R16` replace_stroke / rifle_major_axis — The prop defines the global envelope but was invisible; raised to minor-stroke calibration, still below the body gesture.
- `P1-R17` replace_stroke / ground_weight_cue — Ground cue was invisible; raised just enough to state the two landing heights without competing.
...
- grammar exemplar: `/tmp/skill/img2drawing/src/img2drawing/data/exemplars/full_body_croquis/p1_gesture.png` — representation only
...
- grammar_exemplar: `/tmp/skill/img2drawing/src/img2drawing/data/exemplars/full_body_croquis/p1_gesture.png`
- stage_exemplar: `/tmp/skill/img2drawing/src/img2drawing/data/exemplars/full_body_croquis/p1_gesture.png`
- subject_vs_drawing: `/home/claude/work/croquis/out/reviews/P1_gesture/pass_03/subject_vs_drawing.png`
- subject_split: `/home/claude/work/croquis/out/reviews/P1_gesture/pass_03/subject_split.png`
- subject_drawing_overlay: `/home/claude/work/croquis/out/reviews/P1_gesture/pass_03/subject_drawing_overlay.png`
- subject_drawing_absdiff: `/home/claude/work/croquis/out/reviews/P1_gesture/pass_03/subject_drawing_absdiff.png`
- grammar_vs_drawing: `/home/claude/work/croquis/out/reviews/P1_gesture/pass_03/grammar_vs_drawing.png`
- exemplar_vs_drawing: `/home/claude/work/croquis/out/reviews/P1_gesture/pass_03/grammar_vs_drawing.png`
- overview: `/home/claude/work/croquis/out/reviews/P1_gesture/pass_03/reference_authority_overview.png`
- three_way: `/home/claude/work/croquis/out/reviews/P1_gesture/pass_03/reference_authority_overview.png`
