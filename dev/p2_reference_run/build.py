"""Build the P2 reference run: the canonical example carried through the skill's
...
def main() -> None:
    ...
    try:
        ...
        p1 = Image.open(R / "pass_02/current_drawing.png")
        P2 = work / "reviews/P2_primary_axes"
        p2_pass1 = Image.open(P2 / "pass_01/current_drawing.png")
        p2 = Image.open(P2 / "pass_02/current_drawing.png")
        _sheet([("SUBJECT", sub), ("P1 final", p1), ("P2 pass 1", p2_pass1),
                ("P2 pass 2", p2), ("P2 final over subject", _overlay(sub, p2))],
               OUT / "compare.png")
