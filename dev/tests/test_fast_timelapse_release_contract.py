...
# Historical v1.0.2 implementation authority remains byte-frozen while current source advances.
BASELINE = {
...
def test_current_candidate_version_and_public_identity():
    ...
    assert DEFAULT_SESSION_ID == 'img2drawing-104-vnext'
