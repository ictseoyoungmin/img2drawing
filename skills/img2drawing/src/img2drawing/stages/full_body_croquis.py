...
FULL_BODY_CROQUIS = (
    StageSpec(
        ...
        (
            "a head ovoid with a curved facial centreline crown → nose → chin, plus an eye-line cross",
        ...
        (
            ...
            "facial features, hair, clothing, muscle or closed volume",
        ),
        review_questions=(
            "Overlay P1 on the subject: does the crown sit where the subject's crown sits?",
            ...
            "Do the feet land where the subject's land, pointing the way the subject's point?",
        ...
        advance_when=(
            "Overlaid on the subject, head direction, spine curvature, shoulder and pelvis rotation, both arms, both legs' joint centres and foot landing direction all register.",
        ...
        suggested_crops=("crown+face centreline", "neck+upper spine", "shoulder rhythm", "pelvis+hips", "each arm including occluded ones", "each leg", "feet and ground contact"),
    ),
    StageSpec(
