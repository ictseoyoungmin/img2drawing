...
FULL_BODY_CROQUIS_CONTRACTS = StageContractRegistry((
    StageContract(
        contract_id="full_body_croquis.P1.v2",
        stage_id="P1_gesture",
        tier=1,
        ...
        owns=(
            ...
            "shoulder tilt",
            "pelvis tilt",
            "arm and leg direction paths",
            "foot contact / ground point",
            "overall silhouette envelope (width and height)",
        ...
        allowed_representation=(
            "simple head ovoid with a light centre/tilt indication",
            "one dominant line of action through the body",
            "shoulder line and pelvis line as tilt cues",
            "single-line arm and leg direction paths",
            "ground contact marks under the feet",
            "loose envelope of the whole silhouette",
            "major attached-object axis",
        ),
        ...
        detail_ceiling=(
            "how the figure stands",
            "balance and weight relationship",
            "overall proportion envelope",
    ...
    StageContract(
        contract_id="full_body_croquis.P2.v2",
        stage_id="P2_primary_axes",
        tier=2,
        representation_name="skeletal_axes_and_joints",
        owns=(
            ...
            "ribcage centre axis",
            "pelvis axis",
            "upper-arm and forearm axes",
            "thigh and shin axes",
            "attached-object reference axis relative to the body",
        ),
        inherits_from="P1_gesture",
        must_preserve=(
            "P1 line of action",
            "P1 shoulder and pelvis tilt",
            "P1 ground contact and silhouette envelope",
        ),
        allowed_representation=(
            "joint markers as small circles",
            "limb segments as straight or lightly cylindrical axes",
            "explicit hip → knee → ankle → foot chain",
            "explicit shoulder → elbow → wrist → hand chain",
            "head centreline and facial direction cross",
        ...
        detail_ceiling=(
            "where the bones and joints are",
            "segment direction and foreshortening",
    ...
    StageContract(
        ...
        must_preserve=(
            ...
            "P2 joint positions and segment directions",
            "P2 face direction",
        ),
        allowed_representation=(
            "simple three-dimensional volumes wrapped around the P2 axes",
